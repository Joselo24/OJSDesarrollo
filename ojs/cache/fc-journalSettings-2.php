<?php return array (
  ...
  'categories' => NULL,
  'contactEmail' => 'javierbone15@gmail.com',
  'contactFax' => '',
  'contactName' => 'Carlos  Bone',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
  'displayCurrentIssue' => false,
  'emailHeader' => 'El siguiente mensaje se está enviando a nombre de Ñawi.
________________________________________________________________________',
  'emailSignature' => '________________________________________________________________________
Ñawi
http://localhost/ojs/index.php/nawi',
  'envelopeSender' => '',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  'journalTheme' => 'mpg',
  ...
  'supportEmail' => 'ronny.lucas19@hotmail.com',
  'supportName' => 'Ronny Lucas',
  'supportPhone' => '',
  ...
  array (
    'es_ES' => 'La revista ñawi fue creada sin fines de lucro, para ayudar en temas de investigación a la comunidad de espol.',
  ),
  'authorInformation' => 
  array (
    'es_ES' => '¿Está interesado en publicar en la revista? Se recomienda revisar la página <a href="http://localhost/ojs/index.php/nawi/about">Acerca de la revista</a> para consultar las políticas de sección de la revista, así como las <a href="http://localhost/ojs/index.php/nawi/about/submissions#authorGuidelines">Directrices del autor/a</a>. Los autores/as deben <a href="http://localhost/ojs/index.php/nawi/user/register">registrarse</a> en la revista antes de publicar o, si ya están registrados, pueden simplemente <a href="http://localhost/ojs/index.php/index/login">iniciar sesión</a> y comenzar el proceso de cinco pasos.',
  ),
  ...
  'contactAffiliation' => 
  array (
    'es_ES' => 'Administrador de la revista ñawi',
  ),
  'contactTitle' => 
  array (
    'es_ES' => 'Administrador',
...
al.</strong> El corrector/a de la revista editará el texto para mejorar la fluidez, claridad, gramática, vocabulario y formato del artículo, así como para incluir consultas al autor si es necesario. Una vez que la edición inicial se haya completado, el corrector/a cargará el documento revisado a través del sitio web de la revista y notificará al autor/a que el manuscrito editado está disponible para revisión.</li> <li><strong>Corrección del autor/a.</strong> Antes de realizar cambios radicales en la estructura y organización del manuscrito editado, los autores/as deben comprobarlos con los editores/as que codirigen la pieza. Los autores/as deben aceptar/rechazar cualquier cambio realizado durante la corrección inicial, según convenga, y responder a todas las consultas. Cuando se finalicen las revisiones, los autores/as deben cambiar el nombre del archivo de NombreAutorQA.doc a NombreAutorQAR.doc (p. ej., de LeeQA.doc a LeeQAR.doc) y cargar el documento revisado a través del sitio web de la revista siguiendo las instrucciones.</li> <li><strong>Corrección final.</strong> El corrector/a de la revista comprobará los cambios realizados por el autor/a e incorporará las respuestas a las consultas al autor para crear un manuscrito final. Cuando termine, el corrector/a cargará el documento final a través del sitio web de la revista y enviará una alerta al maquetista para completar el formateado.</li> </ol>',
  ...
  'description' => 
  array (
    'es_ES' => 'Revista Cientifica de ESPOL',
  ),
  ...
  'history' => 
  array (
    'es_ES' => 'Revista científica de ESPOL que será todo un éxito...',
  ),
  'homeHeaderLogoImage' => 
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_salida.png',
      'uploadName' => 'homeHeaderLogoImage_es_ES.png',
      'width' => 241,
      'height' => 136,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 03:52:28',
    ),
  ),
  'homeHeaderTitle' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'Call For Paper',
        'isLiteral' => '1',
        'url' => 'blog.espol.edu.ec/josencat',
        'isAbsolute' => '1',
      ),
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'height' => 136,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 03:56:33',
    ),
  ),
  'pageHeaderTitle' => 
  array (
    'es_ES' => 'Ñawi Revista Científica',
  ),
  'privacyStatement' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'El texto se adhiere a los requisitos estilísticos y biliográficos resumidos en las <a href="http://localhost/ojs/index.php/nawi/about/submissions#authorGuidelines" target="_new">Directrices del autor/a</a>, que aparecen en Acerca de la revista.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'Si se envía a una sección evaluada por pares de la revista, deben seguirse las instrucciones en <a href="javascript:openHelp(\'http://localhost/ojs/index.php/nawi/help/view/editorial/topic/000044\')">Asegurar una evaluación anónima</a>.',
        'order' => '6',
      ),
    ),
  ),
