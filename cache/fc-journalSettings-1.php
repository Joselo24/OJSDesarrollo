<?php return array (
  ...
  'categories' => NULL,
  'contactEmail' => 'ronny.lucas19@hotmail.com',
  'contactFax' => '',
  'contactName' => 'Ronny Lucas',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
  'displayCurrentIssue' => false,
  'emailHeader' => 'El siguiente mensaje se está enviando a nombre de Revista de Prueba.
________________________________________________________________________',
  'emailSignature' => '________________________________________________________________________
Revista de Prueba
http://localhost/ojs/index.php/revistaprueba',
  'envelopeSender' => '',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  ...
  'supportEmail' => 'javierbone15@gmail.com',
  'supportName' => 'Javier Bone',
  'supportPhone' => '',
  ...
  array (
    'es_ES' => 'Estos guantes le permiten al deportista ser identificado a una distancia prudencial de 90 metros.',
  ),
  'authorInformation' => 
  array (
    'es_ES' => '¿Está interesado en publicar en la revista? Se recomienda revisar la página <a href="http://localhost/ojs/index.php/revistaprueba/about">Acerca de la revista</a> para consultar las políticas de sección de la revista, así como las <a href="http://localhost/ojs/index.php/revistaprueba/about/submissions#authorGuidelines">Directrices del autor/a</a>. Los autores/as deben <a href="http://localhost/ojs/index.php/revistaprueba/user/register">registrarse</a> en la revista antes de publicar o, si ya están registrados, pueden simplemente <a href="http://localhost/ojs/index.php/index/login">iniciar sesión</a> y comenzar el proceso de cinco pasos.',
  ),
  ...
  'contactAffiliation' => 
  array (
    'es_ES' => 'Administrador de la revista',
  ),
  'contactTitle' => 
  array (
    'es_ES' => 'Administrador',
...
al.</strong> El corrector/a de la revista editará el texto para mejorar la fluidez, claridad, gramática, vocabulario y formato del artículo, así como para incluir consultas al autor si es necesario. Una vez que la edición inicial se haya completado, el corrector/a cargará el documento revisado a través del sitio web de la revista y notificará al autor/a que el manuscrito editado está disponible para revisión.</li> <li><strong>Corrección del autor/a.</strong> Antes de realizar cambios radicales en la estructura y organización del manuscrito editado, los autores/as deben comprobarlos con los editores/as que codirigen la pieza. Los autores/as deben aceptar/rechazar cualquier cambio realizado durante la corrección inicial, según convenga, y responder a todas las consultas. Cuando se finalicen las revisiones, los autores/as deben cambiar el nombre del archivo de NombreAutorQA.doc a NombreAutorQAR.doc (p. ej., de LeeQA.doc a LeeQAR.doc) y cargar el documento revisado a través del sitio web de la revista siguiendo las instrucciones.</li> <li><strong>Corrección final.</strong> El corrector/a de la revista comprobará los cambios realizados por el autor/a e incorporará las respuestas a las consultas al autor para crear un manuscrito final. Cuando termine, el corrector/a cargará el documento final a través del sitio web de la revista y enviará una alerta al maquetista para completar el formateado.</li> </ol>',
  ...
  'description' => 
  array (
    'es_ES' => 'Permiten a las personas a no contraer cayos en las manos de los usuario',
  ),
  ...
  'history' => 
  array (
    'es_ES' => 'Solo me crearon para prueba',
  ),
  'homeHeaderLogoImage' => 
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_zona.png',
      'uploadName' => 'homeHeaderLogoImage_es_ES.png',
      'width' => 207,
      'height' => 191,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 02:27:59',
    ),
  ),
  'homeHeaderTitle' => 
  array (
    'es_ES' => 'Guantes Direccionales',
  ),
  'homeHeaderTitleImage' => 
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_biblioteca.png',
      'uploadName' => 'homeHeaderTitleImage_es_ES.png',
      'width' => 259,
      'height' => 147,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 02:25:54',
    ),
  ),
  'homeHeaderTitleImageAltText' => 
  array (
    'es_ES' => 'Biblioteca de revista',
  ),
  'homeHeaderTitleType' => 
  array (
    'es_ES' => '1',
  ...
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_rectorado.png',
      'uploadName' => 'homepageImage_es_ES.png',
      'width' => 286,
      'height' => 238,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 02:34:34',
    ),
  ),
  'initials' => 
  array (
  ...
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_llegada.png',
      'uploadName' => 'pageHeaderLogoImage_es_ES.png',
      'width' => 180,
      'height' => 288,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 02:39:23',
    ),
  ),
  ...
  array (
    'es_ES' => 
    array (
      'name' => 'juego_jeo_tecnologia.png',
      'uploadName' => 'pageHeaderTitleImage_es_ES.png',
      'width' => 175,
      'height' => 178,
      'mimeType' => 'image/png',
      'dateUploaded' => '2016-08-06 02:38:55',
    ),
  ),
  'pageHeaderTitleType' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'El texto se adhiere a los requisitos estilísticos y biliográficos resumidos en las <a href="http://localhost/ojs/index.php/revistaprueba/about/submissions#authorGuidelines" target="_new">Directrices del autor/a</a>, que aparecen en Acerca de la revista.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'Si se envía a una sección evaluada por pares de la revista, deben seguirse las instrucciones en <a href="javascript:openHelp(\'http://localhost/ojs/index.php/revistaprueba/help/view/editorial/topic/000044\')">Asegurar una evaluación anónima</a>.',
        'order' => '6',
      ),
    ),
  ),
